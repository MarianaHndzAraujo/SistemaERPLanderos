        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Eliminar Producto</h1>
  ...
  <div class="container">
    ...
    <form action="controlador.php" method="post">
      ...
      <div class="form-group">
        <label><b><h3>Producto: </h3></b></label>
        <label><h3><?php echo $_REQUEST['proP'] ?> </h3></label>
      </div>

      <input type="hidden" name="txtidElimina" value="<?php echo $_REQUEST['idR'] ?>">

      <button type="submit" name="btnEliminaProducto" class="btn btn-danger ">Si, Eliminar </button>
      <button type="submit" name="btnRegresoProducto" class="btn btn-warning">No, Regresar </button>
