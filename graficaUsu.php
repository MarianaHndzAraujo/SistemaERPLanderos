<?php
  $con = new mysqli("localhost","root","","bdlanderos");
  $sql = "select usuario, HorasTrabajadas FROM tbusuarios";
  $res = $con->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <script type="text/javascript">
     ...
     function drawStuff() {
       var data = new google.visualization.arrayToDataTable([
         ...
         <?php
           while ($fila = $res->fetch_assoc()){
             echo "['".$fila["usuario"]."',".$fila["HorasTrabajadas"]."],";
           }
          ?>
       ]);
       ...
       var options = {
         ...
         axes: {
           x: {
             0: { side: 'top', label: 'Horas Trabajadas'} // Top x-axis.
           }
         },
         bar: { groupWidth: "90%" }
       };
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Usuario</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioUsuarios.php">Usuarios</a></li>
  ...
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        ...
        <h3 class="section-sub-title">Horas que trabajan los Empleados</h3>
      </div>
    </div>
    <div class="row text-center">
      <div class="col-12">
