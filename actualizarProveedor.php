                ...
                <div id="navbar-collapse" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav mr-auto">
                      <li class="nav-item dropdown active">
                          <a href="Landeros.php" class="nav-link dropdown-toggle" data-toggle="dropdown">Inicio</a>
                      ...
                      <li class="nav-item dropdown">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="dropdown-submenu">
                              ...
                              <li><a class="dropdown-item" href="inicioFactura.php">Facturación</a></li>
                            </ul>
                          </li>
                            <li><a href="inicioCLientes.php">CLientes</a></li>
                            <li><a href="inicioCompras.php">Compras</a></li>
                          </ul>
                      </li>
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Registro de Proveedores</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioProveedores.php">Proveedores</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Actualizado de Proveedores</li>
                    </ol>
                </nav>
              </div>
          </div><!-- Col end -->
...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Registrar nuevos Proveedores</h2>
        <h3 class="section-sub-title">Actualizar</h3>
      </div>
</div>
    ...
    <form class="" action="controlador.php"  method="POST" onsubmit="return vaciosRegistrar();">
            ...
            <div class="col-md-7">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label> Tipo:</label>
                  <select class="form-control" name="selperfil" style="max-width: 350px;" required >
              ...
              <input type="text" style="max-width: 350px;" class="form-control" id="txtproveedor" name="txtproveedor" value="<?php echo $_REQUEST['pvN'];?>">
              </div>
              </div>
            </div>
          <div class="col-md-5">
            <div align="center"><img src="imagenes/subirImagen.png" alt="..." style="max-width: 10rem;"></div>
          </div>
        </div>
      </div>
      ...
      <div class="card mb-3" style="max-width: 1045px;">
            ...
            <div class="col-md-7">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <h5> Colonia:</h5>
                  <input type="text" style="max-width: 350px;" class="form-control" id="txtcolonia" name="txtcolonia" value="<?php echo $_REQUEST['pvCO'];?>">
                </div>
              <div class="form-group">
              <h5 class="card-title">Ciudad:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtciudad" name="txtciudad" value="<?php echo $_REQUEST['pvCI'];?>">
              </div>
              <div class="form-group">
              <h5 class="card-title">Estado:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtestado" name="txtestado" value="<?php echo $_REQUEST['pvE'];?>">
              </div>
              <div class="form-group">
              <h5 class="card-title">CP:</h5>
              <input type="number" style="max-width: 350px;" class="form-control" id="txtcp" name="txtcp" value="<?php echo $_REQUEST['pvCP'];?>">
              </div>
              <div class="form-group">
              <h5 class="card-title">País:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtpais" name="txtpais" value="<?php echo $_REQUEST['pvPa'];?>">
              </div>
              </div>
            </div>
          <div class="col-md-5">
            ...
            <input type="number" style="max-width: 350px;" class="form-control" id="txttelefono" name="txttelefono" value="<?php echo $_REQUEST['pvTl'];?>">
            </div>
            <div class="form-group">
            <h5 class="card-title">Correo:</h5>
            <input type="email" style="max-width: 350px;" class="form-control" id="txtcorreo" name="txtcorreo" value="<?php echo $_REQUEST['pvC'];?>">
            </div>
            <div class="form-group">
            <h5 class="card-title">Sitio Web:</h5>
            <input type="text" style="max-width: 350px;" class="form-control" id="txtsitio" name="txtsitio" value="<?php echo $_REQUEST['pvS'];?>">
            </div>
          </div>
        </div>
      </div>
        ...
        <button type="submit" name="btnAProveedor" class="btn btn-warning btn-block">Actualizar Proveedor</button>
    </form>
      ...
      <div class="row justify-content-between">
        ...
        <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
          ...
          <ul class="list-arrow">
            ...
            <li><a href="service-single.html">Compras</a></li>
          </ul>
        </div><!-- Col end -->
      </div><!-- Row end -->
    </div><!-- Container end -->
