        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Eliminar Proveedor</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioUsuarios.php">Servicios</a></li>
  ...
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        ...
        <h3 class="section-sub-title">¿Seguro que Eliminaras?</h3>
      </div>
    </div>
    <div class="row text-center">
      <div class="col-12">
    <form action="controlador.php" method="post">
      ...
      <div class="form-group">
        <label><b><h3>Proveedor: </h3></b></label>
        <label><h3><?php echo $_REQUEST['pvN'] ?> </h3></label>
      </div>

      <input type="hidden" name="txtidEliminaProveedor" value="<?php echo $_REQUEST['idR'] ?>">

      <button type="submit" name="btnEliminaProveedor" class="btn btn-danger ">Si, Eliminar </button>
      <button type="submit" name="btnRegresoProveedor" class="btn btn-warning">No, Regresar </button>
