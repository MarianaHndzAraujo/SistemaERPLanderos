        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Eliminar Cliente</h1>
  ...
  <div class="container">
    ...
    <form action="controlador.php" method="post">
      ...
      <div class="form-group">
        <label><b><h3>Cliente: </h3></b></label>
        <label><h3><?php echo $_REQUEST['pvN'] ?> </h3></label>
      </div>

      <input type="hidden" name="txtidEliminaCliente" value="<?php echo $_REQUEST['idR'] ?>">

      <button type="submit" name="btnEliminaCliente" class="btn btn-danger ">Si, Eliminar </button>
      <button type="submit" name="btnRegresoCliente" class="btn btn-warning">No, Regresar </button>
