        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Facturación</h1>
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0"><center>Facturación Ventas</center></h2>
          ...
          <table class="table table-hover">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col"> Imprimir Facturación</th>
              ...
              <?php
                  ...
                  while ($arrV=mysqli_fetch_array($rsUsu)) {
                      echo"<tr>
                        ...
                        <td><a href='formFacturacion.php?idR=".$arrV['idVenta']."&vCliente=".$arrV['Cliente']."&vProducto=".$arrV['Producto']."&vD=".$arrV['Descripcion']."&vCA=".$arrV['Cantidad']."&vPU=".$arrV['PrecioUnitario'].
                      "&vImp=".$arrV['Importe']."&vI=".$arrV['Impuesto']."&vST=".$arrV['SubTotal']."&vE=".$arrV['Expiracion']."&vPlz=".$arrV['PlazoPago']."'><img src=imagenes/facturacion.png></a></td>
