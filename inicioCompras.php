        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Pedidos</h1>
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li class="active"><a href="inicioCompras.php">Consulta Pedidos</a></li>
              <li><a href="formCompras.php">Registrar Pedidos</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Consulta Pedidos</h2>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php
                  ...
                  $rsUsu= consultaCompras();
                  while ($arrUsu=mysqli_fetch_array($rsUsu)) {
                      echo"<tr>
                        <td>".$arrUsu['Proveedor']."</td>
                        <td>".$arrUsu['FechaLimite']."</td>
                        <td>".$arrUsu['FechaRecepcion']."</td>
                        <td>".$arrUsu['Producto']."</td>
                        <td>".$arrUsu['Descripcion']."</td>
                        <td>".$arrUsu['Cantidad']."</td>
                        <td>".$arrUsu['PrecioUnitario']."</td>
                        <td>".$arrUsu['Importe']."</td>
                        <td>".$arrUsu['Impuesto']."</td>
                        <td>".$arrUsu['SubTotal']."</td>
                        <td><a href='actualizarCompra.php?idR=".$arrUsu['idCompra']."&usuPro=".$arrUsu['Proveedor']."&usuFl=".$arrUsu['FechaLimite']."&usuFr=".$arrUsu['FechaRecepcion']."&usuP=".$arrUsu['Producto'].
                        "&usuD=".$arrUsu['Descripcion']."&usuCa=".$arrUsu['Cantidad']."&usuPu=".$arrUsu['PrecioUnitario']."&usuImp=".$arrUsu['Importe']."&usuI=".$arrUsu['Impuesto']."&usuSt=".$arrUsu['SubTotal']."'><img src=imagenes/upload.png></a></td>
                        <td><a href='confirmaEliCompra.php?idR=".$arrUsu['idCompra']."&usuPro=".$arrUsu['Proveedor']."'><img src=imagenes/borrar.png></a></td>
                         </tr>";
                  }
              ?>
            </tbody>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                <div class="call-to-action-btn">
                  <a class="btn btn-primary" href="graficaPedido.php">Ir</a>
                </div>
              </div><!-- col end -->
            </div><!-- row end -->
          </div><!-- Action end -->
