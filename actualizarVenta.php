...
================================================== -->
  <meta charset="utf-8">
  <title>Actualizar de Venta</title>
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Registro de Ventas</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioVentas.php">Ventas</a></li>
...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Registrar nuevos Ventas</h2>
    ...
    <form class="" action="controlador.php"  method="POST" onsubmit="return vaciosRegistrar();">
        ...
        <div class="row no-gutters">
            <div class="col-md-7">
              ...
              <select class="form-control" name="txtcliente" required >
                ...
                $rsCliente= consultaClienteUnico();

                while ($valores = mysqli_fetch_array($rsCliente)) {
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="txtdescripcion" name="txtdescripcion" value="<?php echo $_REQUEST['vD'];?>">
      </div>

      <div class="form-group">
        <label> Cantidad:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" onchange="impuesto();"  id="txtcantidad" name="txtcantidad" value="<?php echo $_REQUEST['vCA'];?>">
      </div>

      <div class="form-group">
        <label>Precio Unitario:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" onchange="impuesto();"  id="txtpreciou" name="txtpreciou" value="<?php echo $_REQUEST['vPU'];?>">
      </div>

      <div class="form-group">
        <label>Importe:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" onchange="impuesto();"  id="txtimporte" name="txtimporte" value="<?php echo $_REQUEST['vImp'];?>">
      </div>

      <div class="form-group">
        <label> Impuestos:</label>
        <input type="number" class="form-control" onchange="impuesto();"  id="txtimpuesto" name="txtimpuesto" value="<?php echo $_REQUEST['vI'];?>">
      </div>

      <div class="form-group">
        <label> Subtotal:</label>
        <input type="number" class="form-control" id="txtsub" name="txtsub" value="<?php echo $_REQUEST['vST'];?>">
      </div>

      <input type="hidden" name="txtidActualizar" value="<?php echo $_REQUEST['idR'] ?>">
          <button type="submit" name="btnAventa" class="btn btn-warning btn-block">Actualizar Venta</button>
    </form>

    <script>
    // si la respuesta que se espera es sumar
    function impuesto(){
        var numero1 = document.getElementById('txtpreciou').value;
