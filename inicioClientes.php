        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Clientes</h1>
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li class="active"><a href="inicioUsuarios.php">Consulta Clientes</a></li>
              <li><a href="formClientes.php">Registrar Clientes</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Consulta Clientes</h2>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php
                  ...
                  $rsCl= consultaClientes();
                  while ($arrPv=mysqli_fetch_array($rsCl)) {
                      echo"<tr>
                      <td>".$arrPv['Cliente']."</td>
                        <td>".$arrPv['Tipo']."</td>
                        <td>".$arrPv['Estado']."</td>
                        ...
                        <td><a href='actualizarCliente.php?idR=".$arrPv['idCliente']."&pvN=".$arrPv['Cliente']."&pvCO=".$arrPv['Colonia']."&pvCI=".$arrPv['Ciudad'].
                        ...
                        <td><a href='confirmaEliCliente.php?idR=".$arrPv['idCliente']."&pvN=".$arrPv['Cliente']."'><img src=imagenes/borrar.png></a></td>
                         </tr>";
                  }
              ?>
            </tbody>
