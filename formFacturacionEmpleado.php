          ...
          <div class="row no-gutters">
            ...
            <div class="col-md-4">
              <div class="card-body">
                ...
                <input type="number" placeholder="0.0" step="any" class="form-control" id="txtnombre" name="monto" value="<?php echo $_REQUEST['vST'];?>">
                <p class="card-text"><small class="text-muted"></small></p>
                </div>
                <div class="form-group">
                <h5 class="card-title">Impuesto:</h5>
                <input type="number" placeholder="0.0" step="any" class="form-control" id="txtnombre" name="txtnombre" value="<?php echo $_REQUEST['vI'];?>">
                <p class="card-text"><small class="text-muted"></small></p>
                </div>
                <div class="form-group">
                <h5 class="card-title">Total:</h5>
                <input type="number" placeholder="0.0" step="any" class="form-control" id="txtnombre" name="txtnombre">
                <p class="card-text"><small class="text-muted"></small></p>
                </div>
              </div>
            </div>
