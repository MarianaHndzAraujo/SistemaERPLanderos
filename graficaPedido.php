<?php
  ...
  $sql = "select Proveedor, Cantidad FROM tbcompras ";
  $res = $con->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
       ...
       var data = new google.visualization.arrayToDataTable([
         ...
         <?php
           while ($fila = $res->fetch_assoc()){
             echo "['".$fila["Proveedor"]."',".$fila["Cantidad"]."],";
           }
          ?>
       ]);
  ...
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        ...
        <h3 class="section-sub-title">Cantidad de Productos por Proveedor</h3>
      </div>
    </div>
    <div class="row text-center">
      <div class="col-12">
