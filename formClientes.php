...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Registrar nuevos Clientes</h2>
      ...
      <div class="card mb-3" style="max-width: 1045px;">
        <div class="row no-gutters">
            <div class="col-md-7">
              ...
              <input type="text" style="max-width: 350px;" class="form-control" id="txtCliente" name="txtCliente">
              </div>
              </div>
            </div>
          <div class="col-md-5">
      ...
      <div class="card mb-3" style="max-width: 1045px;">
        <div class="row no-gutters">
            <div class="col-md-7">
              ...
              <input type="text" style="max-width: 350px;" class="form-control" id="txtcp" name="txtcp">
              </div>
              <div class="form-group">
        ...
        <button type="submit" name="btnGCliente" class="btn btn-warning btn-block">Guardar Cliente</button>
    </form>
