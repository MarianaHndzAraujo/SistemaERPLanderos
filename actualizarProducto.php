        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Registro de Productos</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioProductos.php">Productos</a></li>
...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Registrar nuevos Productos</h2>
...
<div class="col-md-8">
  <div class="card-body">
    ...
    <input type="text" class="form-control" id="txtproducto" name="txtproducto" value="<?php echo $_REQUEST['proP'];?>">
...
<input type="number" placeholder="0.0" step="any" class="form-control" id="txtpreciov" name="txtpreciov" value="<?php echo $_REQUEST['proPv'];?>">
</div>

<div class="form-group">
<label> Impuesto cliente:</label>
<input type="number" placeholder="0.0" step="any" class="form-control" id="txtimpuesto" name="txtimpuesto" value="<?php echo $_REQUEST['proImp'];?>">
</div>

<div class="form-group">
        <label> Categoría de Producto:</label>
        <select class="form-control" name="txtcategoria" required >
          <option value>Elije Categoria Producto...</option>
          <?php
            require 'funcionesBD.php';
            $rsCaP= consultaCategoriaP();

              while ($valores = mysqli_fetch_array($rsCaP)) {
...
<input type="number" class="form-control" id="txtcodigobarrar" name="txtcodigobarrar" value="<?php echo $_REQUEST['proCob'];?>">
</div>

    <input type="hidden" name="txtidPActualizar" value="<?php echo $_REQUEST['idR'] ?>">
    <button type="submit" name="btnAproducto" class="btn btn-warning btn-block">Actualizar Producto</button>
    </form>
