  ...
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        ...
        <h3 class="section-sub-title">Actualización</h3>
      </div>
</div>
    ...
    <form class="" action="controlador.php"  method="POST" onsubmit="return vaciosRegistrar();">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-5">
            <div class="card-body">
              ...
              <h5 class="card-title">Fecha límite de pedido:</h5>
              <input type="date" class="form-control" id="txtfl" name="txtfl" value="<?php echo $_REQUEST['usuFl'];?>">
              <p class="card-text"><small class="text-muted"></small></p>
              </div>
              <div class="form-group">
              <h5 class="card-title">Fecha de recepción:</h5>
              <input type="date" class="form-control" id="txtfr" name="txtfr" value="<?php echo $_REQUEST['usuFr'];?>">
              <p class="card-text"><small class="text-muted"></small></p>
              </div>
            </div>
          </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="txtdescripcion" name="txtdescripcion" value="<?php echo $_REQUEST['usuD'];?>">
      </div>

      <div class="form-group">
        <label> Cantidad:</label>
        <input type="number" class="form-control" id="txtcantidad" onchange="impuesto();" name="txtcantidad" value="<?php echo $_REQUEST['usuCa'];?>">
      </div>

      <div class="form-group">
        <label>Precio Unitario:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" onchange="impuesto();" id="txtpu" name="txtpu" value="<?php echo $_REQUEST['usuPu'];?>">
      </div>

      <div class="form-group">
        <label>Importe:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" onchange="impuesto();"  id="txtimporte" name="txtimporte" value="<?php echo $_REQUEST['usuImp'];?>">
      </div>

      <div class="form-group">
        <label> Impuestos:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" id="txtimpuesto" name="txtimpuesto" value="<?php echo $_REQUEST['usuI'];?>">
      </div>

      <div class="form-group">
        <label> Subtotal:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" id="txtsub" name="txtsub" value="<?php echo $_REQUEST['usuSt'];?>">
      </div>

      <input type="hidden" name="txtidActualizar" value="<?php echo $_REQUEST['idR'] ?>">
      <button type="submit" name="btnAcompra" class="btn btn-warning btn-block">Actualizar Pedidos</button>
    </form>
