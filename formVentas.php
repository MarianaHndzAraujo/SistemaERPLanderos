  ...
  <div class="container">
    ...
    <form class="" action="controlador.php"  method="POST" onsubmit="return vaciosRegistrar();">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-5">
            <div class="card-body">
              ...
              <input type="date" class="form-control" id="txtexpiracion" name="txtexpiracion">
              <p class="card-text"><small class="text-muted"></small></p>
              </div>
              <div class="form-group">
              <h5 class="card-title">Plazo de pago:</h5>
              <input type="date" class="form-control" id="txtplazo" name="txtplazo">
              <p class="card-text"><small class="text-muted"></small></p>
              </div>
            </div>
          </div>
      ...
      <div class="form-group">
        ...
        <input type="number" placeholder="0.0" step="any" class="form-control" onchange="impuesto();" id="txtpreciou" name="txtpreciou">
      </div>

      <div class="form-group">
        <label>Importe:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control" id="txtimporte" name="txtimporte">
      </div>

      <div class="form-group">
        <label> Impuestos:</label>
        <input type="number" placeholder="0.0" step="any" class="form-control"  onchange="impuesto();" id="txtimpuesto" name="txtimpuesto" value="0.16">
      </div>
      ...
      <div class="form-group">
        ...
        <button type="submit" name="btnGventas" class="btn btn-warning btn-block">Guardar Ventas</button>
    </form>
