        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Registro de Clientes</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioClientes.php">Clientes</a></li>
...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Actualizar  Clientes</h2>
      ...
      <div class="card mb-3" style="max-width: 1045px;">
        <div class="row no-gutters">
            <div class="col-md-7">
              ...
              <input type="text" style="max-width: 350px;" class="form-control" id="txtCliente" name="txtCliente" value="<?php echo $_REQUEST['pvN'];?>">
              </div>
              </div>
            </div>
          <div class="col-md-5">
      ...
      <div class="card mb-3" style="max-width: 1045px;">
        <div class="row no-gutters">
            <div class="col-md-7">
              ...
              <input type="text" style="max-width: 350px;" class="form-control" id="txtcp" name="txtcp" value="<?php echo $_REQUEST['pvCP'];?>">
              </div>
              <div class="form-group">
              <h5 class="card-title">País:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtpais" name="txtpais" name="txtpais" value="<?php echo $_REQUEST['pvPa'];?>">
              </div>
              </div>
            </div>
          <div class="col-md-5">
        ...
        <button type="submit" name="btnACliente" class="btn btn-warning btn-block">Actualizar Cliente</button>
    </form>
