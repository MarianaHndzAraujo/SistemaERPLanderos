<?php
  ...
  $sql = "select Producto, Cantidad from tbventas";
  $res = $con->query($sql);
?>
        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Gráfica de Ventas</h1>
  ...
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        ...
        <h3 class="section-sub-title">Cantidad de Productos Vendidos</h3>
      </div>
    </div>
    <div class="row text-center">
      <div class="col-12">
