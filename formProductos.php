...
<input type="number" class="form-control" id="txtcodigobarrar" name="txtcodigobarrar">
</div>

        <button type="submit" name="btnGProducto" class="btn btn-warning btn-block">Guardar Producto</button>
    </form>
