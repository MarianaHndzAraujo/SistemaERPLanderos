  ...
  <div class="container">
    ...
    <form class="" action="controlador.php"  method="POST" onsubmit="return vaciosRegistrar();">
      <div class="card mb-3" style="max-width: 1045px;">
        <div class="row no-gutters">
            <div class="col-md-7">
              ...
              <input type="text" style="max-width: 350px;" class="form-control" id="txtproveedor" name="txtproveedor">
              </div>
              </div>
            </div>
          <div class="col-md-5">
      ...
      <div class="card mb-3" style="max-width: 1045px;">
            ...
            <div class="col-md-7">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <h5> Colonia:</h5>
                  <input type="text" style="max-width: 350px;" class="form-control" id="txtcolonia" name="txtcolonia">
                </div>
              <div class="form-group">
              <h5 class="card-title">Ciudad:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtciudad" name="txtciudad">
              </div>
              <div class="form-group">
              <h5 class="card-title">Estado:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtestado" name="txtestado">
              </div>
              <div class="form-group">
              <h5 class="card-title">CP:</h5>
              <input type="number" style="max-width: 350px;" class="form-control" id="txtcp" name="txtcp">
              </div>
              <div class="form-group">
              <h5 class="card-title">País:</h5>
              <input type="text" style="max-width: 350px;" class="form-control" id="txtpais" name="txtpais">
              </div>
              </div>
            </div>
          <div class="col-md-5">
            ...
            <input type="number" style="max-width: 350px;" class="form-control" id="txttelefono" name="txttelefono">
            </div>
            <div class="form-group">
            <h5 class="card-title">Correo:</h5>
            <input type="email" style="max-width: 350px;" class="form-control" id="txtcorreo" name="txtcorreo">
            </div>
            <div class="form-group">
            <h5 class="card-title">Sitio Web:</h5>
            <input type="text" style="max-width: 350px;" class="form-control" id="txtsitio" name="txtsitio">
            </div>
          </div>
        </div>
      </div>
        ...
        <button type="submit" name="btnGProveedor" class="btn btn-warning btn-block">Guardar Proveedor</button>
    </form>
