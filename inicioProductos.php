        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Productos</h1>
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li class="active"><a href="inicioUsuarios.php">Consulta Productos</a></li>
              <li><a href="formProductos.php">Registrar Productos</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Consulta Productos</h2>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php
                  ...
                  $rsProducto= consultaProducto();
                  while ($arrPro=mysqli_fetch_array($rsProducto)) {
                      echo"<tr>
                        <td>".$arrPro['Producto']."</td>
                        <td>".$arrPro['PrecioVenta']."</td>
                        <td>".$arrPro['Cantidad']."</td>
                        <td>".$arrPro['CategoriaProducto']."</td>
                        <td>".$arrPro['CodigoBarras']."</td>
                        <td><a href='actualizarProducto.php?idR=".$arrPro['idProducto']."&proP=".$arrPro['Producto']."&proPv=".$arrPro['PrecioVenta']."&proImp=".$arrPro['Cantidad']."&proCate=".$arrPro['CategoriaProducto']."&proCob=".$arrPro['CodigoBarras']."'><img src=imagenes/upload.png></a></td>
                        <td><a href='confirmaEliProducto.php?idR=".$arrPro['idProducto']."&proP=".$arrPro['Producto']."'><img src=imagenes/borrar.png></a></td>
                         </tr>";
                  }
              ?>
              </tbody>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                <div class="call-to-action-btn">
                  <a class="btn btn-primary" href="graficaProducto.php">Ir</a>
                </div>
              </div><!-- col end -->
            </div><!-- row end -->
          </div><!-- Action end -->
