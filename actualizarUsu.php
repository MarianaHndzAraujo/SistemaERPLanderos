        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Registro de Usuarios</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                      <li class="breadcrumb-item"><a href="Landeros.php">Inicio</a></li>
                      <li class="breadcrumb-item"><a href="inicioUsuarios.php">Usuario</a></li>
...
<section id="main-container" class="main-container">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-12">
        <h2 class="section-title">Registrar nuevos Empleados</h2>
    ...
    <form class="" action="controlador.php"  method="POST" onsubmit="return vaciosRegistrar();">
      <div class="card mb-3" style="max-width: 1045px;">
        <div class="row no-gutters">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <input type="text" class="form-control" id="txtnombre" name="txtnombre" value="<?php echo $_REQUEST['usuR'];?>">
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" id="txtcorreo" name="txtcorreo" value="<?php echo $_REQUEST['usuC'];?>">
        </div>

      <div class="form-group">
        <label> Contraseña:</label>
        <input type="password" class="form-control" id="txtpass" name="txtpass" value="<?php echo $_REQUEST['usuPass'];?>">
      </div>

      <div class="form-group">
        <label> Confirma contraseña:</label>
        <input type="password" class="form-control" id="txtcpass" name="txtcpass" value="<?php echo $_REQUEST['usuPass'];?>">
      </div>

      <div class="form-group">
        <label> Perfil:</label>
        <select class="form-control" name="selperfil" required >
          <option value>Elije Perfil...</option>
      ...
      <div class="form-group">
        <label> Horas Laborables:</label>
        <input type="number" class="form-control" id="txthl" name="txthl" value="<?php echo $_REQUEST['usuHL'];?>">
      </div>
      <input type="hidden" name="txtidActualizar" value="<?php echo $_REQUEST['idR'] ?>">
      <button type="submit" name="btnAusu" class="btn btn-warning btn-block">Actualizar Usuario</button>
    </form>
