        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Ventas</h1>
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li class="active"><a href="inicioUsuarios.php">Consulta Ventas</a></li>
              <li><a href="formVentas.php">Registrar Ventas</a></li>
              <li><a href="inicioFactura.php">Facturación</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Consulta Ventas</h2>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php
                  ...
                  $rsUsu= consultaVentas();
                  while ($arrV=mysqli_fetch_array($rsUsu)) {
                      echo"<tr>
                        <td>".$arrV['Cliente']."</td>
                        <td>".$arrV['Producto']."</td>
                        <td>".$arrV['Descripcion']."</td>
                        <td>".$arrV['Cantidad']."</td>
                        <td>".$arrV['PrecioUnitario']."</td>
                        <td>".$arrV['Importe']."</td>
                        <td>".$arrV['Impuesto']."</td>
                        <td>".$arrV['SubTotal']."</td>
                        <td>".$arrV['Expiracion']."</td>
                        <td>".$arrV['PlazoPago']."</td>
                        <td><a href='actualizarVenta.php?idR=".$arrV['idVenta']."&vCliente=".$arrV['Cliente']."&vProducto=".$arrV['Producto']."&vD=".$arrV['Descripcion']."&vCA=".$arrV['Cantidad']."&vPU=".$arrV['PrecioUnitario'].
                       "&vImp=".$arrV['Importe']."&vI=".$arrV['Impuesto']."&vST=".$arrV['SubTotal']."&vE=".$arrV['Expiracion']."&vPlz=".$arrV['PlazoPago']."'><img src=imagenes/upload.png></a></td>
                        <td><a href='confirmaEliVenta.php?idR=".$arrV['idVenta']."&vCliente=".$arrV['Cliente']."'><img src=imagenes/borrar.png></a></td>
                         </tr>";
                  }
              ?>
            </tbody>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                <div class="call-to-action-btn">
                  <a class="btn btn-primary" href="graficaVenta.php">Ir</a>
                </div>
              </div><!-- col end -->
            </div><!-- row end -->
          </div><!-- Action end -->
