        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">Usuarios</h1>
    ...
    <div class="row">
        ...
        <div class="sidebar sidebar-left">
          <div class="widget">
            ...
            <ul class="nav service-menu">
              <li class="active"><a href="inicioUsuarios.php">Consulta Usuarios</a></li>
              <li><a href="formUsuarios.php">Registrar Usuarios</a></li>
            </ul>
          </div><!-- Widget end -->
      ...
      <div class="col-xl-8 col-lg-8">
        <div class="content-inner-page">
          ...
          <h2 class="column-title mrt-0">Consulta Usuarios</h2>
          ...
          <table class="table table-hover">
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col">Horas Laborables</th>
              ...
              <?php
                  ...
                  while ($arrUsu=mysqli_fetch_array($rsUsu)) {
                      echo"<tr>
                        ...
                        <td>".$arrUsu['pass']."</td>
                        <td>".$arrUsu['perfil']."</td>
                        <td>".$arrUsu['HorasTrabajadas']."</td>
                        <td><a href='actualizarUsu.php?idR=".$arrUsu['idUsuario']."&usuR=".$arrUsu['usuario']."&usuC=".$arrUsu['correo']."&usuPass=".$arrUsu['pass']."&usuHL=".$arrUsu['HorasTrabajadas']."'><img src=imagenes/upload.png></a></td>
                        <td><a href='confirmaEliUsu.php?idR=".$arrUsu['idUsuario']."&usuR=".$arrUsu['usuario']."'><img src=imagenes/borrar.png></a></td>
                         </tr>";
                  }
              ?>
            </tbody>
            ...
            <div class="row align-items-center">
              <div class="col-md-8 text-center text-md-left">
                <div class="call-to-action-text">
                  <h3 class="action-title">Visualizar Gráfica</h3>
                </div>
              </div><!-- Col end -->
              <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
                <div class="call-to-action-btn">
                  <a class="btn btn-primary" href="graficaUsu.php">Ir</a>
                </div>
              </div><!-- col end -->
            </div><!-- row end -->
          </div><!-- Action end -->
